...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-aedcfhm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-aedcfhm.containers.anotherwebservice.com/
...
```
git clone git@github.com:fanj66/container-aedcfhm.git
cd container-aedcfhm
```
...
```
docker attach container-aedcfhm
```
